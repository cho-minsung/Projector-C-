...
//----------------------------------------------------------------------------------------	
void DefaultBPPolicy::addWeight(int _iRayIndex, int _iVolumeIndex, float _fWeight)
{
...
//----------------------------------------------------------------------------------------	
void DiffFPPolicy::addWeight(int _iRayIndex, int _iVolumeIndex, float _fWeight)
{
...
//----------------------------------------------------------------------------------------	
void StorePixelWeightsPolicy::addWeight(int _iRayIndex, int _iVolumeIndex, float _fWeight)
{
...
//----------------------------------------------------------------------------------------	
void TotalPixelWeightBySinogramPolicy::addWeight(int _iRayIndex, int _iVolumeIndex, float _fWeight)
{
...
//----------------------------------------------------------------------------------------	
void TotalPixelWeightPolicy::addWeight(int _iRayIndex, int _iVolumeIndex, float _fWeight)
{
...
//----------------------------------------------------------------------------------------	
void TotalRayLengthPolicy::addWeight(int _iRayIndex, int _iVolumeIndex, float _fWeight)
{
...
//----------------------------------------------------------------------------------------	
template<typename P1, typename P2>
void CombinePolicy<P1, P2>::addWeight(int _iRayIndex, int _iVolumeIndex, float _fWeight)
{
...
//----------------------------------------------------------------------------------------	
template<typename P1, typename P2, typename P3>
void Combine3Policy<P1, P2, P3>::addWeight(int _iRayIndex, int _iVolumeIndex, float _fWeight)
{
	policy1.addWeight(_iRayIndex, _iVolumeIndex, _fWeight);
	policy2.addWeight(_iRayIndex, _iVolumeIndex, _fWeight);
...
//----------------------------------------------------------------------------------------	
template<typename P1, typename P2, typename P3, typename P4>
void Combine4Policy<P1, P2, P3, P4>::addWeight(int _iRayIndex, int _iVolumeIndex, float _fWeight)
{
	policy1.addWeight(_iRayIndex, _iVolumeIndex, _fWeight);
	policy2.addWeight(_iRayIndex, _iVolumeIndex, _fWeight);
	policy3.addWeight(_iRayIndex, _iVolumeIndex, _fWeight);
...
//----------------------------------------------------------------------------------------	
template<typename P>
void CombineListPolicy<P>::addWeight(int _iRayIndex, int _iVolumeIndex, float _fWeight)
{
	for (unsigned int i = 0; i < size; ++i) {
...
//----------------------------------------------------------------------------------------	
void EmptyPolicy::addWeight(int _iRayIndex, int _iVolumeIndex, float _fWeight)
{
	// nothing
}
//----------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------	
void SIRTBPPolicy::addWeight(int _iRayIndex, int _iVolumeIndex, float _fWeight)
{
	float fGammaBeta = m_pTotalPixelWeight->getData()[_iVolumeIndex] * m_pTotalRayLength->getData()[_iRayIndex];
...
//----------------------------------------------------------------------------------------	
void SinogramMaskPolicy::addWeight(int _iRayIndex, int _iVolumeIndex, float _fWeight)
{
	// nothing
}
//----------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------	
void ReconstructionMaskPolicy::addWeight(int _iRayIndex, int _iVolumeIndex, float _fWeight)
{
	// nothing
}
//----------------------------------------------------------------------------------------
