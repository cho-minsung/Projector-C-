...
/**
	...
	*/
class CProjector2DManager : public Singleton<CProjector2DManager>, public CAstraObjectManager<CProjector2D>
{
...
/**
	...
	* Indices are always >= 1.
	*/
class CData2DManager : public Singleton<CData2DManager>, public CAstraObjectManager<CFloat32Data2D>
{
...
/**
	...
	* Indices are always >= 1.
	*/
class CAlgorithmManager : public Singleton<CAlgorithmManager>, public CAstraObjectManager<CAlgorithm>
{
...
/**
	...
	* Indices are always >= 1.
	*/
class CMatrixManager : public Singleton<CMatrixManager>, public CAstraObjectManager<CSparseMatrix>
{
