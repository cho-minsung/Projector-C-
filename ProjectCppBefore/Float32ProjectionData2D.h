...
/**
	...
	*/
class CFloat32ProjectionData2D : public CFloat32Data2D {
...
public:
	...
	/**
		...
		*/
	CFloat32ProjectionData2D(CProjectionGeometry2D* _pGeometry, float* _pfData);
	...
	/**
		...
		*/
	CFloat32ProjectionData2D(CProjectionGeometry2D* _pGeometry, float _fScalar);
	...
	/** Initialization. Initializes an instance of the CFloat32Data2D class with initialization of the data block.
		...
		* @param _pfData pointer to a one-dimensional float data block
		*/
	bool initialize(CProjectionGeometry2D* _pGeometry, const float* _pfData);
	...
	/** Initialization. Initializes an instance of the CFloat32Data2D class with initialization of the data block.
		...
		* @param _fScalar scalar value to be put at each index.
		*/
	bool initialize(CProjectionGeometry2D* _pGeometry, float _fScalar);
	...
	/** Get a pointer to the data of a single projection angle.
		...
		*/
	float* getSingleProjectionData(int _iAngleIndex);
	...
	/** Get a const pointer to the data of a single projection angle.
		...
		* @return pointer to the data
		*/
	const float* getSingleProjectionDataConst(int _iAngleIndex) const;
